...
class ScoreScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        highScoreTitle.position = CGPoint(x: view.frame.midX, y: view.frame.midY)
        ...
        highScoreLabel.position = CGPoint(x: view.frame.midX, y: view.frame.midY)
        ...
        scoreTitle.position = CGPoint(x: view.frame.midX, y: view.frame.midY)
        ...
        scoreLabel.position = CGPoint(x: view.frame.midX, y: view.frame.midY)
        ...
        button.position = CGPoint(x: view.frame.midX, y: view.frame.midY)
